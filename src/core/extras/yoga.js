...
import { isFlexDirection, isJustifyContent, isAlignItems, isAlignContent, isFlexWrap } from '../validation/TypeValidators.js'
...
export { isFlexDirection, isJustifyContent, isAlignItems, isAlignContent, isFlexWrap }
export const isDisplay = (v) => ['flex', 'none'].includes(v)
export const isAlignItem = isAlignItems
