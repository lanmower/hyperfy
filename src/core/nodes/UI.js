...
import { UIInteractionHandler } from './ui/UIInteractionHandler.js'
...
export class UI extends Node {
  constructor(data = {}) {
    ...
    this.interactionHandler = new UIInteractionHandler(this)
  ...
  resolveHit(hit) {
    return this.interactionHandler.resolveHit(hit)
  }
