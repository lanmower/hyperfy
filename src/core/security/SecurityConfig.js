// Shared security configuration - works in both server and client contexts
// Server imports this as fallback; server-specific config overrides via /src/server/config/SecurityConfig.js
