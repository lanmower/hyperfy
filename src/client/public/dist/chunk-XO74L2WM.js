...
// src/core/utils/logging/LogLevels.js
var LogLevels = {
  TRACE: 0,
  DEBUG: 1,
  INFO: 2,
...
// src/core/utils/logging/StructuredLogger.js
var StructuredLogger = class _StructuredLogger {
  ...
  formatLog(level, message, context = {}) {
    const timestamp = this.includeTimestamp ? (/* @__PURE__ */ new Date()).toISOString() : null;
  ...
  createChild(childCategory) {
    const child = new _StructuredLogger(childCategory, {
...
function defaultConsoleHandler(logEntry) {
...
typedArrayTags[argsTag2] = typedArrayTags[arrayTag] = typedArrayTags[arrayBufferTag2] = typedArrayTags[boolTag3] = typedArrayTags[dataViewTag2] = typedArrayTags[dateTag2] = typedArrayTags[errorTag2] = typedArrayTags[funcTag2] = typedArrayTags[mapTag2] = typedArrayTags[numberTag2] = typedArrayTags[objectTag] = typedArrayTags[regexpTag2] = typedArrayTags[setTag2] = typedArrayTags[stringTag2] = typedArrayTags[weakMapTag] = false;
...
var PACKET_NAMES = Object.values(PacketTypes);

// src/core/plugins/core/MessageHandler.js
var logger = new StructuredLogger("MessageHandler");
